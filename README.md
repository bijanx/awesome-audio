...
https://github.com/chaosprint/glicol?tab=readme-ov-file
...
#### textbeat: 🎹 plaintext music sequencer and midi shell, with vim playback and the powers of music theory 🥁
https://github.com/flipcoder/textbeat

#### audioMotion.js: Media player and real-time audio spectrum analyzer written in JavaScript.
...
#### spectro: 🎶 Real-time audio spectrogram generator for the web
https://github.com/calebj0seph/spectro?tab=readme-ov-file
...
https://github.com/audacity/audacity?tab=readme-ov-file
...
#### synth-recipes: Code snippets of sound synthesis algorithms in C++
https://github.com/hollance/synth-recipes?tab=readme-ov-file

#### RTspice: A real-time netlist based audio circuit plugin
https://github.com/thadeuluiz/RTspice

#### llama3.cuda: llama3.cuda is a pure C/CUDA implementation for Llama 3 model.
